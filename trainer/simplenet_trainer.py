...
# 		self.optim.proj_opt = get_optim(cfg.optim.proj_opt.kwargs, self.net.module.net_simplenet.pre_projection, lr=cfg.optim.lr*.1)
# 		self.optim.dsc_opt = get_optim(cfg.optim.dsc_opt.kwargs, self.net.module.net_simplenet.discriminator, lr=cfg.optim.lr*.2)
# 		print('optim finish!')
...
# 		params.append(self.net.module.net_simplenet.pre_projection.parameters())
# 		params.append(self.net.module.net_simplenet.discriminator.parameters())
...
# 			self.scores, self.preds = self.net.module.net_simplenet.predict(test_data)
# 			# self.forward()
# 			# self.net.predict()
# 			# loss_cos = self.loss_terms['sum'](self.true_loss, self.fake_loss)
# 			loss_cos = 0
