...
from mask_transfor import random_rorate,merge_images,little_rorate_and_move,random_3direcions_rotate,visa_candle
import random
import PIL
...
def main():
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="textual_inversion-main/models/v1-5-pruned.ckpt",
    ...
    config = OmegaConf.load("textual_inversion-main/configs/stable-diffusion/generate_with_mask.yaml")
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        for i in range(opt.n_samples):
                            ...
                            if class_name in ["pcb1","pcb2","pcb3"]:
                                mask_image = little_rorate_and_move(mask_image,distance=0.02,tranpose=True)
                                
                            elif class_name == "pcb4":
                                mask_image = little_rorate_and_move(mask_image,distance=0.02)
                                
                            elif class_name =="fryum":
